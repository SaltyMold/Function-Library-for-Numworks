...
int randint(int min, int max); // Random int between min and max
const char* choice(const char *list[], size_t size); // Random choice in list with size elements


char* input(eadk_point_t point, bool draw_string, bool large_font); // Return the input of the user with point, draw_string and large_font in argument
int input_int(eadk_point_t point, bool draw_string, bool large_font); // Return the int input of the user with point, draw_string and large_font in argument

void crash_calculator(); // Instant crash and reset of the calculator


void decode_and_draw_image(eadk_rect_t rect, const char *code); // Decode and draw the image coded by the python progam with rect and code in argument
